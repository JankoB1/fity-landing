    ...
    return (
        <>
            <div className="privacy-page">
                ...
                <p>Marko Ristić PR Barbell</p>
                <p>Pop Lukina 5, Šabac, 15000</p>
                <p>68026032</p>
                <p>Kontakt: marko@barbell.rs</p>
                ...
                <p>Zahtev možete poslati na: <strong>marko@barbell.rs</strong>. Takođe, u svakom newsletteru postoji link za odjavu (unsubscribe).</p>
                ...
                <p><strong>Kontakt za privatnost:</strong> marko@barbell.rs</p>
            </div>
            <Footer></Footer>
        </>
    );
